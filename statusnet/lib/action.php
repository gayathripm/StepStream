...
$this->script('graphs.js');
   ...
   function showBodyMe()
     ...
     * @return nothing
     */
    function showNoticeForm($pageType)
    {
 ...
 $this->elementStart('input',array('id' => 'user_id_graph' ,'type' => 'hidden', 'value' => $user->id));
    ...
    function showCore($pageType)
    {
        ...
        if (Event::handle('StartShowContentBlock', array($this))) {
            $this->showContentBlock($pageType);
            $this->flush();
  ...
  function showCoreMe()
     ...
     * @return nothing
     */
    function showContentBlock($pageType)
    {
        $this->elementStart('div', array('id' => 'content'));
        if (common_logged_in()) {
            if (Event::handle('StartShowNoticeForm', array($this))) {
                $this->showNoticeForm($pageType);
