...
class AllAction extends ProfileAction
{
    ...
    function prepare($args)
    {
        ...
        $stream = new StepsNoticeStream($this->user, Profile::current());
...
class StepsNoticeStream extends ScopingNoticeStream
{
    function __construct($profile, $userProfile = -1)
    {
        ...
        parent::__construct(new CachingNoticeStream(new RawStepsNoticeStream($profile),
                                                    'profile:notice_ids:' . $profile->id),
                            $userProfile);
    }
}

class RawStepsNoticeStream extends NoticeStream
{
    protected $profile;
    ...
    function getNoticeIds($offset, $limit, $since_id, $max_id)
    {
        ...
        $notice->object_type = 'http://activitystrea.ms/schema/1.0/event';
        $notice->selectAdd();
        $notice->selectAdd('id');
